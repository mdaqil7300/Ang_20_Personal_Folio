...
export class AboutComponent {
  ...
  expertise = [
    ...
    },
    {
      ...
      description:
        "Proficient in NgRx, RxJS and Signals for managing complex application state and reactive data flows",
    },
    // {
    //   icon: 'users',
